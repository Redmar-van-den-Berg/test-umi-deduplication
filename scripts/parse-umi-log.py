...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--umi-tools", required=True, nargs="+", help="stdout from umi_tools dedup"
    )
    parser.add_argument(
        "--samples", required=True, nargs="+", help="Sample names, on order"
    )
    parser.add_argument(
        "--humid", required=True, nargs="+", help="stats.dat from HUMID"
    )
